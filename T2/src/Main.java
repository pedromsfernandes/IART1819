...
public class Main {
    ...
    public static void usage() {
        ...
        System.out.println("Where ALGORITHM can be one of the following: GENETIC, HILLCLIMB_SIMPLE, HILLCLIMB_STEEPEST or ANNEALING.");
        System.out.println("Example: java Main ../res/exam_comp_set1.exam GENETIC");
    }

    public static void main(String[] args) {

        ArrayList<String> algorithms = new ArrayList<String>(Arrays.asList("GENETIC", "HILLCLIMB_SIMPLE", "HILLCLIMB_STEEPEST", "ANNEALING"));
